    ...
    <>
      <div className="p-2">
        <div className="group inline-block relative transition-all duration-500">
          <button
            className=" 
           font-semibold  rounded inline-flex justify-center items-center w-24"
          >
            ...
            <li className="">
              <a href="/">
                <button
                 ...
                 text-white border-white border-2 py-2 px-4 w-24 flex justify-center transition-all duration-500 "
                >
                  English
                </button>
              </a>
